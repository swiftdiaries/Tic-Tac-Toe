...
@property (nonatomic) NSInteger activePlayer;
@property (nonatomic, copy) NSArray * __nonnull gameState;
@property (nonatomic, copy) NSArray * __nonnull winningCombinations;
@property (nonatomic) BOOL gameActive;
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified button;
- (IBAction)playagainButton:(id __nonnull)sender;
